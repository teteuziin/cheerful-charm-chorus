...
export const navItems: NavItem[] = [
  { label: "Hoje", to: "/today", icon: Home, description: "Sua rotina de hoje" },
  { label: "Jornada", to: "/jornada", icon: RouteIcon, description: "Sua evolução" },
  { label: "Equipe", to: "/equipe", icon: Users, description: "Profissionais" },
